...
const DashboardTab = () => {
    ...
    const { mode, product, edithandle, deleteProduct, loading, order, user } = context
    let [isOpen, setIsOpen] = useState(false)

    const deleteAlertBox = (item) => {
        swal({
            title: "Are you sure?",
            text: "You will not be able to recover this data field.!",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#FA4D47",
                                                        ...
                                                        <td className="px-6 py-4">
                                                            <div className=" flex gap-2">
                                                                <div className=" flex gap-2 cursor-pointer text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                    <div onClick={() => deleteAlertBox(item)}>
                            ...
                            <div className="relative overflow-x-auto mb-16">
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'dark' ? 'white' : '' }}>Order Details</h1>
                                       {order.map((allorder, index)=>(
                                         <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                         <thead  className="text-xs text-black shadow-[inset_0_0_8px_rgba(0,0,0,0.6)] uppercase bg-gray-200 " style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                             <tr>
                                                 <th scope="col" className="px-6 py-3">
                                                     Payment Id
                                                 </th>
                                         ...
                                         {allorder.cartItems.map((item, index)=>(
                                            ...
                                            <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                ...
                                                <th scope="row" className="px-6 py-4 font-medium text-black whitespace-nowrap">
                                                    <img className='w-16' src={allorder.imageUrl} alt="img" />
                                                </th>
                                                <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                    {allorder.title}
                                                </td>

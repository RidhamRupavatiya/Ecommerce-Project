...
function Cart() {
  ...
  const shipingAmount = totalAmount > 300 || totalAmount == 0 ? 0 : 40;
  

  const grandTotal = totalAmount + shipingAmount;
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
              ...
              <div className="justify-between mb-6 rounded-lg border drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                  <div className="mt-5 sm:mt-0">
                    ...
                    <h2 className="t ext-md  text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>{item.description}</h2>
                    <p className="mt-2 text-md font-semibold text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{item.price}</p>
                  </div>
                  <div onClick={() => deleteCart(item)} className="mt-4 hover:cursor-pointer flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            <div className="flex justify-between">
              ...
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>{shipingAmount}</p>
            </div>
            <hr className="my-4" />
